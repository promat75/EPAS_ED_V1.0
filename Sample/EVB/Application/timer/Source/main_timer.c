...
// Key Input Process
		if(SYS_Uart1Get(&u8KeyIn))
		{
			...
			{	
				...
				zPrintf(1, "\n a : Again Previous VerifyCmd");
				zPrintf(1, "\n ------------------------------------------------");
				zPrintf(1, "\n [0x0c00] Timer0-98ms:P0.0 toggle");
				zPrintf(1, "\n ------------------------------------------------");
				zPrintf(1, "\n [0x0c10] Timer1-98ms:P0.1 toggle");
				zPrintf(1, "\n ------------------------------------------------");
				zPrintf(1, "\n [0x0c20] Timer2-65.534ms:P0.2 toggle");
				zPrintf(1, "\n [0x0c21] Timer2-200ms:P0.2 toggle");
				zPrintf(1, "\n ------------------------------------------------");
				zPrintf(1, "\n [0x0c30] Timer3-24.75ms:P0.3 toggle");
				zPrintf(1, "\n [0x0c31] Timer3-500ms:P0.3 toggle");
				zPrintf(1, "\n ------------------------------------------------");
				zPrintf(1, "\n [0x0c40] Timer0,1,2,3 : 30,50,90,150ms");
				zPrintf(1, "\n ================================================");
...
//==============================
		...
		switch(u16VerifyCmdID)
		{
			...
			//==========================================================================
			case (TIMER_CODE | 0x20)	:
				zPrintf(1, "\n [0x0c20] Timer2-65.534ms:P0.2 toggle");
				HAL_Timer2ClockOn(ON);
				HAL_Timer2IntSet(ENABLE, PRIORITY_HIGH, RUN, 65534);
				zPrintf(1, " => Complete\n");
			break;
			//--------------------------------------------------------------------------------------------
			case (TIMER_CODE | 0x21)	:
				zPrintf(1, "\n [0x0c21] Timer2-200ms:P0.2 toggle");
				HAL_Timer2ClockOn(ON);
				HAL_Timer2IntSet(ENABLE, PRIORITY_HIGH, RUN, 200000);
				zPrintf(1, " => Complete\n");
			break;
			//==========================================================================

			//==========================================================================
			case (TIMER_CODE | 0x30)	:
				zPrintf(1, "\n [0x0c30] Timer3-24.75ms:P0.3 toggle");
				HAL_Timer3ClockOn(ON);
				HAL_Timer3IntSet(ENABLE, PRIORITY_HIGH, RUN, 24750);
				zPrintf(1, " => Complete\n");
			break;
			//--------------------------------------------------------------------------------------------
			case (TIMER_CODE | 0x31)	:
				zPrintf(1, "\n [0x0c31] Timer3-500ms:P0.3 toggle");
				HAL_Timer3ClockOn(ON);
				HAL_Timer3IntSet(ENABLE, PRIORITY_HIGH, RUN, 500000);
				zPrintf(1, " => Complete\n");
			break;
			//==========================================================================

			//==========================================================================
			case (TIMER_CODE | 0x40)	:
				zPrintf(1, "\n [0x0c40] Timer0,1,2,3 : 30,50,90,150ms");
				HAL_Timer0ClockOn(ON);
				HAL_Timer1ClockOn(ON);
				HAL_Timer2ClockOn(ON);
				HAL_Timer3ClockOn(ON);
				HAL_Timer0IntSet(ENABLE, PRIORITY_LOW, RUN, 30);
				HAL_Timer1IntSet(ENABLE, PRIORITY_LOW, RUN, 50);
				HAL_Timer2IntSet(ENABLE, PRIORITY_LOW, RUN, 90000);
				HAL_Timer3IntSet(ENABLE, PRIORITY_LOW, RUN, 150000);
				zPrintf(1, " => Complete\n");
			break;
			//==========================================================================
